...
var entityModuleGenerator = yeoman.generators.NamedBase.extend({
	init: function() {
	...
	askForModuleFolders: function() {
		...
		var prompts = [{
			...
			type: 'confirm',
			name: 'addMenuItems',
			message: 'Would you like to add the Module links to a menu?',
			default: true
		}];
...
module.exports = entityModuleGenerator;